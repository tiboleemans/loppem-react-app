            ...
            <Grid container spacing={2}>
                      ...
                      <CardContent className="pricing1__card-content">
                        <h1 className="mt-0 mb-4 text-24"> Nederlands / Engels</h1>
                          ...
                          <div className="px-3 py-2">
                              <Grid container spacing={2}>
                                  <Grid container item justify="flex-end" md={7}><span className="text-20"><strong>Basisprijs</strong></span></Grid>
                                  <Grid container item justify="flex-end" md={4}><span className="text-20"><strong>€ 740</strong></span></Grid>
                    ...
                    <Card className={clsx("text-center card", classes.card)}>
                        ...
                        <CardContent className="pricing1__card-content">
                            ...
                            <div className="px-3 py-2">
                                <Grid container spacing={2}>
                                    <Grid container item justify="flex-end" md={7}><span className="text-20"><strong>Basisprijs</strong></span></Grid>
                                    <Grid container item justify="flex-end" md={4}><span className="text-20"><strong>€ 690</strong></span></Grid>
                                    <Grid md={7} container item justify="flex-end" >Tijdelijke korting</Grid>
                                    <Grid md={4} container item justify="flex-end" >-€20</Grid>
                                    <Grid md={7} container item justify="flex-end" >Speciale korting</Grid>
                                    <Grid md={4} container item justify="flex-end" >-€20</Grid>
                ...
                <Grid item lg={6} md={6} sm={12} xs={12}>
                    <Card className="py-8 px-6 card">
                        ...
                        <p className="m-0">€ 20 bij het aanbrengen van een nieuwe leerling, onder de volgende voorwaarden:
                            <ul>
                                ...
                                <li>De nieuw aangebrachte leerling behoort niet tot hetzelfde gezin (dus inwonend op hetzelfde adres).</li>
                                <li>U vermeldt de naam van deze leerling duidelijk in het inschrijvingsformulier op de website in het daartoe bestemde vakje.</li>
                                <li>U kunt elkaar niet wederzijds aanbrengen.</li>
                            </ul>
                            Deze korting wordt pas toegekend en <strong>terugbetaald NA de stage </strong>.
                        </p>
                    </Card>
                </Grid>
                <Grid item lg={6} md={6} sm={12} xs={12}>
                    <Card className="py-8 px-6 card">
                        ...
                        <p className="m-0">U betaalt het voorschot onmiddellijk na de inschrijving en het saldo voor één juni 2021. U kan verschillende kortingen combineren tot een maximum van 40 euro per inschrijving.
                            Sommige ziekenfondsen komen tussenbeide in de inschrijvingskosten. Informeer bij uw ziekenfonds. Voor leerlingen tot 12 jaar wordt een fiscaal attest voor opvang opgeleverd.</p>
                    </Card>
                </Grid>
                <Grid item lg={6} md={6} sm={12} xs={12}>
                    <Card className="py-8 px-6 card">
