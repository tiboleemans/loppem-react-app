...
function preValidateFinal(data) {
  ...
  const schema = joi.object({
    ...
    student: joi.object().keys({
      ...
      period: joi.string().trim().max(100).required(),
      firstName: joi.string().trim().max(100).required(),
      lastName: joi.string().trim().max(100).required(),
      gender: joi.string().trim().max(100).required(),
    ...
    parent: joi.object().keys({
      ...
      lastName: joi.string().trim().max(100).required(),
      // email: joi.string().trim().email().required(),
      email: joi.string().trim().required().max(100),
      relation: joi.string().trim().required().max(100),
      street: joi.string().trim().required().max(100),
      houseNr: joi.string().trim().required().max(100),
      busNr: joi.string().trim().allow('').max(100),
      city: joi.string().trim().required().max(100),
      zipCode: joi.string().trim().required().max(100),
      gsm: joi.string().trim().required().max(100),
      gsm2: joi.string().trim().allow(''),
    }),
    school: joi.object().keys({
      name: joi.string().trim().required().max(100),
      city: joi.string().trim().required().max(100),
      years: joi.string().trim().required().max(100),
      hours: joi.string().trim().required().max(100),
      immersion: joi.string().trim().required().max(100),
    }),
    extra: joi.object().keys({
